            ...
            <div className="menu">
                <div className="menu-body">
                    <ul>
                        ...
                        <li onMouseEnter={this.handleMouseHover(2)} onClick={this.props.switchContent(2)}><span>02</span>Home</li>
                        <li onMouseEnter={this.handleMouseHover(3)} onClick={this.props.switchContent(3)}><span>03</span>Home</li>
                        <li onMouseEnter={this.handleMouseHover(4)} onClick={this.props.switchContent(4)}><span>04</span>Home</li>
                        <li onMouseEnter={this.handleMouseHover(5)} onClick={this.props.switchContent(5)}><span>05</span>Home</li>
                        <li onMouseEnter={this.handleMouseHover(6)} onClick={this.props.switchContent(6)}><span>06</span>Home</li>
                    </ul>
                </div>
                ...
                <div className="container">
                    <ul style={{top:-this.state.hovrIdx * 23 + "rem"}}>
                        ...
                        <li><span>02</span>Home</li>
                        <li><span>03</span>Home</li>
                        <li><span>04</span>Home</li>
                        <li><span>05</span>Home</li>
                        <li><span>06</span>Home</li>
                    </ul>
                </div>
                </div>
            </div>
