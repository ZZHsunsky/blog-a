...
export default class TravelContent extends React.Component{
    ...
    getMapSvg = () => {
      return  ( <g clipPath="url(#Map-mask)" fill="rgba(255, 255, 255, 1)" id="Map-shape">
    ...
    render() {
        ...
        return (
            <div className="Container">
              <div className="Map-container" style={{height: document.body.clientHeight || window.innerWidth}}>
                <svg xmlns="http://www.w3.org/2000/svg" version="1.1"viewBox="0 0 670.2 432.4" id="map-svg">
                  <defs>
